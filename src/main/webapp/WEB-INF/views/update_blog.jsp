...
<body
	...
	<div class="min-h-screen flex items-center justify-center">
		<div class="w-full max-w-2xl bg-white rounded-xl shadow-lg p-8">
			...
			<!-- Blog Upload Form -->
			<form
				action="${pageContext.request.contextPath}/blogs/update/${blog.id}?v=${System.currentTimeMillis()}"
				...
				<div>
					...
					<textarea name="description" rows="3"
						class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500">${blog.description}</textarea>
